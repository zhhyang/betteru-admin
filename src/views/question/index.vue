...
import { Edit, Delete, Plus, View, Search } from '@element-plus/icons-vue'
import { v4 as uuidv4 } from 'uuid'
import { getSurveyQuestionList } from '@/api/question'
...
const editQuestion = (question) => {
  ...
  // 确保选项数组存在
  if (!currentQuestion.options && (currentQuestion.type === 'radio' || currentQuestion.type === 'checkbox')) {
